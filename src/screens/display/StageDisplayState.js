...
/**
 * The {@link screens.display.StageDisplayState} enumeration defines the different display state of the stage.
 * @summary The {@link screens.display.StageDisplayState} enumeration defines the different display state of the stage.
 * @name StageDisplayState
 * @namespace screens.dsiplay.StageDisplayState
 * @memberof
 */
export var StageDisplayState = Object.defineProperties( {} ,
{
     ...
     * @memberof screens.dsiplay.StageDisplayState
     * @type {string}
     * @default fullScreen
     */
